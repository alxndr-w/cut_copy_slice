var cut_copy_slice = {
    ...
    getPlugins : function(initializable)
    {
        ...
        return this.plugins.filter(function(value){
            ...
            return typeof(value) == 'string' && typeof(cut_copy_slice[value]) != 'undefined' && (!initializable || typeof(cut_copy_slice[value].init) == 'function');
        });
...
$(document).on('rex:ready', $.proxy(cut_copy_slice.init, cut_copy_slice));
