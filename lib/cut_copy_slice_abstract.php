<?php
/**
 * cut_copy_slice abstract class - basic functions for the addon and its plugins.
 */
abstract class cut_copy_slice_abstract
{
    /**
     ...
     * @var string
     */
    protected static $addon_name = 'cut_copy_slice';
